...
class Challenge:
    def __init__(self, challenge_name):
        ...
        self.question_key = None  # question key data for randomisation of image-related questions
        ...
        self.display_question = None  # to determine which question will be displayed from the options below
    ...
    def answer(self, correct_ans):
        """Takes player's answer and determines if correct
                ...
                """
        player_input = None  # pygame object for player input OR button choice
    ...
    def incorrect_response(self):
        ...
        return incorrect_response_message
        # move to next challenge
...
def main():
    ...
    return satellite_challenge.greet()
