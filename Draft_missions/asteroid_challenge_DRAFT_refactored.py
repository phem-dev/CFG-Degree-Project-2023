...
class Asteroids(Challenge):
    ...
    def asteroid_distance_prompt(self, asteroid_distances):
        #print("58") debugging
        return f"For any of the 3 asteroids that passed near Earth today, enter the miss distance rounded to the nearest km. You have 3 attempts... ", self.player_enter_asteroid_distance(asteroid_distances)
